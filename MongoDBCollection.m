...
//                                 self.fullyQualifiedName.bsonString,
                                 [self.fullyQualifiedName cStringUsingEncoding:NSUTF8StringEncoding],
                                 document.bsonValue,
...
- (BOOL) insertDictionary:(NSDictionary *) dictionary
             writeConcern:(MongoWriteConcern *) writeConcern
                    error:(NSError * __autoreleasing *) error {
    return [self insertDocument:[BSONEncoder documentForDictionary:dictionary] writeConcern:writeConcern error:error];
}
